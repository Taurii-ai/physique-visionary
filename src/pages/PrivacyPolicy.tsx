            ...
            <div className="prose prose-invert max-w-none space-y-8">
              ...
              <section className="space-y-4">
                ...
                <ul className="space-y-2 text-muted-foreground ml-4">
                  ...
                  <li><strong>Application</strong> refers to SculptyAI, the software program provided by the Company.</li>
                  <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to SculptyAI.</li>
              ...
              <section className="space-y-4">
                ...
                <h4 className="text-md font-semibold text-foreground">Information Collected while Using the Application</h4>
                <p className="text-muted-foreground leading-relaxed">
              ...
              <section className="space-y-4">
                ...
                <p className="text-muted-foreground leading-relaxed">We may share Your personal information in the following situations:</p>
                <ul className="space-y-2 text-muted-foreground ml-4">
              ...
              <section className="space-y-4">
                <h2 className="text-2xl font-bold text-foreground">Transfer of Your Personal Data</h2>
                <p className="text-muted-foreground leading-relaxed">
              ...
              <section className="space-y-4">
                <h2 className="text-2xl font-bold text-foreground">Delete Your Personal Data</h2>
                <p className="text-muted-foreground leading-relaxed">
              ...
              <section className="space-y-4">
                <h2 className="text-2xl font-bold text-foreground">Disclosure of Your Personal Data</h2>

                <h3 className="text-lg font-semibold text-accent">Business Transactions</h3>
                <p className="text-muted-foreground leading-relaxed">
                  If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.
                </p>

                <h3 className="text-lg font-semibold text-accent">Law enforcement</h3>
                <p className="text-muted-foreground leading-relaxed">
                  Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).
                </p>

                <h3 className="text-lg font-semibold text-accent">Other legal requirements</h3>
                <p className="text-muted-foreground leading-relaxed">The Company may disclose Your Personal Data in the good faith belief that such action is necessary to:</p>
                <ul className="space-y-1 text-muted-foreground ml-4">
              ...
              <section className="space-y-4">
                ...
                <div className="bg-card/30 rounded-lg p-4 border border-border/30">
                  <p className="text-muted-foreground">By email: <span className="text-accent font-medium">sculptyaiapp@gmail.com</span></p>
                  <p className="text-muted-foreground">By visiting this page on our website: <span className="text-accent font-medium">sculptyai.com</span></p>
                </div>
